...
if __name__ == "__main__":
    ...
    player7 = Player("Moeen Ali", 0.9, 0.8, 0.8, 0.7, 0.9)
    player8 = Player("Ravindra Jadeja", 0.9, 0.8, 0.5, 0.6, 0.7)
    player9 = Player("Deepak Chahar", 0.8, 0.5, 0.7, 0.5, 0.7)
    player10 = Player("Mitchell Santner", 0.8, 0.7, 0.6, 0.6, 0.7)
    player11 = Player("Rajvardhan Hangargekar", 0.8, 0.5, 0.8, 0.7, 0.7)
